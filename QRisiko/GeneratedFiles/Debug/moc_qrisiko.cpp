...
static const char qt_meta_stringdata_QRisiko[] = {
    "QRisiko\0\0identita\0cliccato(int)\0"
    "new_size\0resized(QSize)\0funziona(int)\0"
};
...
void QRisiko::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->resized((*reinterpret_cast< QSize(*)>(_a[1]))); break;
        case 2: _t->funziona((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
